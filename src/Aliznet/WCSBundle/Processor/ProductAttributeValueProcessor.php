 ...
 */
class ProductAttributeValueProcessor extends AbstractConfigurableStepElement implements ItemProcessorInterface
{
    /** @var Serializer */
        ...
        foreach ($product->getValues() as $value) {
            ...
            if (count($value->getOption()) > 0) {
                ...
                if (!empty($code)) {
                    ...
                    $attr_value = $value->getOption()->getOptionValue()->getValue();
                }
            }
